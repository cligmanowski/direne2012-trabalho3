...
print "\nFoi passado como parâmetro {0} coisas !!.\n".format(tamanho_argumentos)
...
def round_robin(jogadores):
	...
	while (i<=tamanho_argumentos-1):
		...
		if ((i-1)== 0): #Só para que na primeira iteração o último da lista passe
			#para a posição 1 da lista
...
'''
#Algoritmo TODO:
	fazer o controle de uma execução 
	fazer html
